...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff4B140A);
  static const Color secondary = Color(0xffFF9E4A);
  ...
  static const Color grad1Color = Color(0xffFF9E4A);
  static Color grad2Color = Color(0xffFF9E4A).withOpacity(0.6);
