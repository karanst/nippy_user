...
class MapPage extends StatefulWidget {
  ...
  bool live;
  String? id;
  MapPage(this.status,{ this.SOURCE_LOCATION, this.DEST_LOCATION,required this.live,this.id,this.pick="",this.dest=""});
...
class MapPageState extends State<MapPage> with AutomaticKeepAliveClientMixin{
  ...
  //           Uri.parse(
  //               baseUrl1+"Payment/get_driver_details"),
  //           data);
  //       print(response);
  //       print(response);
  //       bool status = true;
  ...
  void setSourceAndDestinationIcons() async {
    sourceIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 0.2), 'assets/logo/source.png');
    // if(widget.live){

        driverIcon = await BitmapDescriptor.fromAssetImage(
            ImageConfiguration(devicePixelRatio: 0.2), 'assets/logo/flag.png');

    // }

    destinationIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 0.2),
        'assets/logo/arrival.png');
    if(widget.status){
      setState(() {
  ...
  void setMapPins() async{
    ...
    //     if(widget.carType!=null&&widget.carType ==widget.driveList[i].car_type ){
    ...
    //           double.parse(widget.driveList[i].longitude));
          ...
          // if(widget.carType=="1"){
            markerIcon =
            await getBytesFromAsset('assets/cars/flag.png', 100);
          // }else{
          //   markerIcon =
          //   await getBytesFromAsset('assets/cars/car2.png', 50);
          // }
